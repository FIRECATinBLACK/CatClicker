...
The cursor health trace includes aggregate evdev retirement, rescan, reopen, synchronization, duplicate-position, and bounded stale-recovery counters. It does not include coordinates, keys, or device identities.
